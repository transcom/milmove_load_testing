...
with prime_client.ApiClient() as api_client:
    ...
    body = UpdateMTOShipment(
        ...
        pickup_address=MTOShipmentWithoutServiceItemsPickupAddress(),
        destination_address=MTOShipmentWithoutServiceItemsDestinationAddress(),
        destination_type=DestinationType("OTHER_THAN_AUTHORIZED"),
        secondary_pickup_address=MTOShipmentWithoutServiceItemsSecondaryPickupAddress(),
        secondary_delivery_address=MTOShipmentWithoutServiceItemsSecondaryDeliveryAddress(),
        storage_facility=MTOShipmentWithoutServiceItemsStorageFacility(),
        shipment_type=MTOShipmentType("HHG"),
        diversion=True,
        point_of_contact="point_of_contact_example",
        counselor_remarks="counselor approved",
