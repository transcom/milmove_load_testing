...
class UploadWithOmissions(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, filename, content_type, bytes, *args, **kwargs):  # noqa: E501
        """UploadWithOmissions - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, filename, content_type, bytes, *args, **kwargs):  # noqa: E501
        """UploadWithOmissions - a model defined in OpenAPI
