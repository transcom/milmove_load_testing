...
def lazy_import():
    ...
    globals()['MTOServiceItemDomesticStandaloneCrating'] = MTOServiceItemDomesticStandaloneCrating
...
class MTOServiceItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, move_task_order_id, model_type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, move_task_order_id, model_type, *args, **kwargs):  # noqa: E501
        """MTOServiceItem - a model defined in OpenAPI
