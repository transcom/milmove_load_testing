...
def lazy_import():
    ...
    globals()['UpdateMTOServiceItemSIT'] = UpdateMTOServiceItemSIT
    globals()['UpdateMTOServiceItemShuttle'] = UpdateMTOServiceItemShuttle


class UpdateMTOServiceItem(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'UpdateMTOServiceItemSIT': UpdateMTOServiceItemSIT,
            'UpdateMTOServiceItemShuttle': UpdateMTOServiceItemShuttle,
        }
        if not val:
            return None
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, model_type, *args, **kwargs):  # noqa: E501
        """UpdateMTOServiceItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, model_type, *args, **kwargs):  # noqa: E501
        """UpdateMTOServiceItem - a model defined in OpenAPI
