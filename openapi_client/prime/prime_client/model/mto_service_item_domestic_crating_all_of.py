...
class MTOServiceItemDomesticCratingAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, re_service_code, item, crate, description, *args, **kwargs):  # noqa: E501
        """MTOServiceItemDomesticCratingAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, re_service_code, item, crate, description, *args, **kwargs):  # noqa: E501
        """MTOServiceItemDomesticCratingAllOf - a model defined in OpenAPI
