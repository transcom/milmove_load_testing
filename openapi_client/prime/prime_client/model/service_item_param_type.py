...
class ServiceItemParamType(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'DECIMAL': "DECIMAL",
            'TIMESTAMP': "TIMESTAMP",
            'PAYMENTSERVICEITEMUUID': "PaymentServiceItemUUID",
            'BOOLEAN': "BOOLEAN",
        },
    }
    ...
    def __init__(self, *args, **kwargs):
        """ServiceItemParamType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["STRING", "DATE", "INTEGER", "DECIMAL", "TIMESTAMP", "PaymentServiceItemUUID", "BOOLEAN", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["STRING", "DATE", "INTEGER", "DECIMAL", "TIMESTAMP", "PaymentServiceItemUUID", "BOOLEAN", ]  # noqa: E501
