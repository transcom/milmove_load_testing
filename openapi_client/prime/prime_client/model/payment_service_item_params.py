...
class PaymentServiceItemParams(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PaymentServiceItemParams - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([PaymentServiceItemParam]):  # noqa: E501

        Keyword Args:
            value ([PaymentServiceItemParam]):  # noqa: E501
