...
class MTOShipmentWithoutServiceItemsSecondaryDeliveryAddress(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MTOShipmentWithoutServiceItemsSecondaryDeliveryAddress - a model defined in OpenAPI
