...
class UpdateMTOServiceItemModelType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """UpdateMTOServiceItemModelType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Using this list, choose the correct modelType in the dropdown, corresponding to the service item type.   * DDDSIT - UpdateMTOServiceItemSIT   * DOPSIT - UpdateMTOServiceItemSIT   * DOASIT - UpdateMTOServiceItemSIT   * DOFSIT - UpdateMTOServiceItemSIT   * DDSHUT - UpdateMTOServiceItemShuttle   * DOSHUT - UpdateMTOServiceItemShuttle  The documentation will then update with the supported fields. ., must be one of ["UpdateMTOServiceItemSIT", "UpdateMTOServiceItemShuttle", ]  # noqa: E501
