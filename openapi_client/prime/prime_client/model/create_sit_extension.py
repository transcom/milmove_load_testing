...
class CreateSITExtension(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, request_reason, contractor_remarks, requested_days, *args, **kwargs):  # noqa: E501
        """CreateSITExtension - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, request_reason, contractor_remarks, requested_days, *args, **kwargs):  # noqa: E501
        """CreateSITExtension - a model defined in OpenAPI
