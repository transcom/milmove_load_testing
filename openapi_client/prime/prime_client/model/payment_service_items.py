...
class PaymentServiceItems(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PaymentServiceItems - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([PaymentServiceItem]):  # noqa: E501

        Keyword Args:
            value ([PaymentServiceItem]):  # noqa: E501
