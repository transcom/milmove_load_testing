...
class MTOShipmentWithoutServiceItemsSecondaryPickupAddress(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MTOShipmentWithoutServiceItemsSecondaryPickupAddress - a model defined in OpenAPI
