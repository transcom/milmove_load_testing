...
class MTOServiceItemDomesticStandaloneCratingAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, item, crate, description, *args, **kwargs):  # noqa: E501
        """MTOServiceItemDomesticStandaloneCratingAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            re_service_code (str): A unique code for the service item. Indicates if the service is for crating (DCRTSA).. defaults to "DCRTSA", must be one of ["DCRTSA", ]  # noqa: E501
        ...
        re_service_code = kwargs.get('re_service_code', "DCRTSA")
    ...
    @convert_js_args_to_python_args
    def __init__(self, item, crate, description, *args, **kwargs):  # noqa: E501
        """MTOServiceItemDomesticStandaloneCratingAllOf - a model defined in OpenAPI
