...
class MTOShipments(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """MTOShipments - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([MTOShipment]): A list of shipments..  # noqa: E501

        Keyword Args:
            value ([MTOShipment]): A list of shipments..  # noqa: E501
