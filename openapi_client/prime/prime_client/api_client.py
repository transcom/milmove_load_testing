...
from prime_client import rest
from prime_client.configuration import Configuration
from prime_client.exceptions import ApiTypeError, ApiValueError, ApiException
from prime_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = MoveTaskOrderApi()
        api_instance.create_excess_weight_record  # this is an instance of the class Endpoint
        api_instance.create_excess_weight_record()  # this invokes api_instance.create_excess_weight_record.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_excess_weight_record.callable or self.callable in this class
