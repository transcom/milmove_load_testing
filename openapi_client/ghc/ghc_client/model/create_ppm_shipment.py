...
class CreatePPMShipment(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, expected_departure_date, pickup_address, destination_address, sit_expected, estimated_weight, has_pro_gear, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, expected_departure_date, pickup_address, destination_address, sit_expected, estimated_weight, has_pro_gear, *args, **kwargs):  # noqa: E501
        """CreatePPMShipment - a model defined in OpenAPI
