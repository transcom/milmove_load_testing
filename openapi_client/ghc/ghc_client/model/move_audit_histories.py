...
class MoveAuditHistories(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """MoveAuditHistories - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([MoveAuditHistory]):  # noqa: E501

        Keyword Args:
            value ([MoveAuditHistory]):  # noqa: E501
