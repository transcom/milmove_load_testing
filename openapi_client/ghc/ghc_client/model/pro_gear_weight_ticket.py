...
class ProGearWeightTicket(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ppm_shipment_id, updated_at, created_at, document_id, document, *args, **kwargs):  # noqa: E501
        """ProGearWeightTicket - a model defined in OpenAPI

        Args:
            ppm_shipment_id (str): The ID of the PPM shipment that this pro-gear weight ticket is associated with.
            updated_at (datetime):
            created_at (datetime):
