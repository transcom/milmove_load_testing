...
class EvaluationReportList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """EvaluationReportList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([EvaluationReport]):  # noqa: E501

        Keyword Args:
            value ([EvaluationReport]):  # noqa: E501
