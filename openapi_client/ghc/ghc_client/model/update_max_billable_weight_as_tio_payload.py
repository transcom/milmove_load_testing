...
class UpdateMaxBillableWeightAsTIOPayload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, authorized_weight, tio_remarks, *args, **kwargs):  # noqa: E501
        """UpdateMaxBillableWeightAsTIOPayload - a model defined in OpenAPI
        ...
        self.authorized_weight = authorized_weight
        self.tio_remarks = tio_remarks
    ...
    @convert_js_args_to_python_args
    def __init__(self, authorized_weight, tio_remarks, *args, **kwargs):  # noqa: E501
        """UpdateMaxBillableWeightAsTIOPayload - a model defined in OpenAPI
