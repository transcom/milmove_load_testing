...
class MTOServiceItemDimensions(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """MTOServiceItemDimensions - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([MTOServiceItemDimension]):  # noqa: E501

        Keyword Args:
            value ([MTOServiceItemDimension]):  # noqa: E501
