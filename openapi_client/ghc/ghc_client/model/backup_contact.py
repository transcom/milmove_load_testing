...
class BackupContact(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, email, phone, *args, **kwargs):  # noqa: E501
        """BackupContact - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, email, phone, *args, **kwargs):  # noqa: E501
        """BackupContact - a model defined in OpenAPI
