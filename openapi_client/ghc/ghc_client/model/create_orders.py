...
class CreateOrders(ModelNormal):
    ...
    attribute_map = {
        'service_member_id': 'serviceMemberId',  # noqa: E501
        'issue_date': 'issueDate',  # noqa: E501
        'report_by_date': 'reportByDate',  # noqa: E501
        'orders_type': 'ordersType',  # noqa: E501
        'has_dependents': 'hasDependents',  # noqa: E501
        'spouse_has_pro_gear': 'spouseHasProGear',  # noqa: E501
    ...
    def _from_openapi_data(cls, service_member_id, issue_date, report_by_date, orders_type, has_dependents, spouse_has_pro_gear, new_duty_location_id, *args, **kwargs):  # noqa: E501
        """CreateOrders - a model defined in OpenAPI
