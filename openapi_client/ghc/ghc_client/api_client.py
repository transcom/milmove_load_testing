...
from ghc_client import rest
from ghc_client.configuration import Configuration
from ghc_client.exceptions import ApiTypeError, ApiValueError, ApiException
from ghc_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_customer  # this is an instance of the class Endpoint
        api_instance.get_customer()  # this invokes api_instance.get_customer.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_customer.callable or self.callable in this class
