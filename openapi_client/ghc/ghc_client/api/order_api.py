...
class OrderApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.upload_amended_orders_endpoint = _Endpoint(
            settings={
                ...
                'auth': [],
                'endpoint_path': '/orders/{orderID}/upload_amended_orders',
    ...
    def create_order(
        ...
        **kwargs
        ...
        Creates an instance of orders tied to a service member, which allow for creation of a move and an entitlement. Orders are required before the creation of a move  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        Keyword Args:
            create_orders (CreateOrders): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def upload_amended_orders(
        ...
        **kwargs
        ...
        >>> thread = api.upload_amended_orders(order_id, file, async_req=True)
        >>> result = thread.get()
