...
class UploadsApi(object):
    ...
    def create_upload(
        ...
        **kwargs
        ...
        Uploads represent a single digital file, such as a JPEG or PDF. Currently, office application uploads are only for Services Counselors to upload files for orders, but this may be expanded in the future.  # noqa: E501
