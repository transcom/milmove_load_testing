...
class OfficeUsersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_requested_office_user_endpoint = _Endpoint(
            settings={
                'response_type': (OfficeUser,),
                'auth': [],
                'endpoint_path': '/open/requested-office-users',
                'operation_id': 'create_requested_office_user',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def create_requested_office_user(
        ...
        **kwargs
        ...
        return self.create_requested_office_user_endpoint.call_with_http_info(**kwargs)
