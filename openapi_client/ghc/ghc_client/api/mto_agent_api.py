...
class MtoAgentApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.fetch_mto_agent_list_endpoint = _Endpoint(
            settings={
                ...
                'auth': [],
                'endpoint_path': '/move_task_orders/{moveTaskOrderID}/mto_shipments/{shipmentID}/mto-agents',
    ...
    def fetch_mto_agent_list(
        ...
        **kwargs
        ...
        Fetches a list of agents associated with a move task order.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.fetch_mto_agent_list(move_task_order_id, shipment_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['shipment_id'] = \
            shipment_id
        return self.fetch_mto_agent_list_endpoint.call_with_http_info(**kwargs)
