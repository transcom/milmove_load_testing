...
class MoveTaskOrderApi(object):
    ...
    def update_move_task_order(
        ...
        **kwargs
        ...
        >>> thread = api.update_move_task_order(move_task_order_id, if_match, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['body'] = \
            body
        return self.update_move_task_order_endpoint.call_with_http_info(**kwargs)
