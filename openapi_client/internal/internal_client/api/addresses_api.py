...
class AddressesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.show_address_endpoint = _Endpoint(
            settings={
                'response_type': (Address,),
                'auth': [],
                'endpoint_path': '/addresses/{addressId}',
                'operation_id': 'show_address',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def show_address(
        ...
        **kwargs
        ...
        >>> thread = api.show_address(address_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['address_id'] = \
            address_id
        return self.show_address_endpoint.call_with_http_info(**kwargs)
