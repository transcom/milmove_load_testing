...
class CalendarApi(object):
    ...
    def show_available_move_dates(
        ...
        **kwargs
        ...
        >>> thread = api.show_available_move_dates(start_date, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['start_date'] = \
            start_date
        return self.show_available_move_dates_endpoint.call_with_http_info(**kwargs)
