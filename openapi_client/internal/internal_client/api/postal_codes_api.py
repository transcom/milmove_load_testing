...
class PostalCodesApi(object):
    ...
    def validate_postal_code_with_rate_data(
        self,
        postal_code,
        postal_code_type,
        **kwargs
        ...
        Verifies if a zipcode is valid for origin or destination location for a move.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.validate_postal_code_with_rate_data(postal_code, postal_code_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['postal_code'] = \
            postal_code
        kwargs['postal_code_type'] = \
            postal_code_type
        return self.validate_postal_code_with_rate_data_endpoint.call_with_http_info(**kwargs)
