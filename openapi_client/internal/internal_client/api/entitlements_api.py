...
class EntitlementsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.validate_entitlement_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/entitlements/{moveId}',
                'operation_id': 'validate_entitlement',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def index_entitlements(
        ...
        **kwargs
        ...
        >>> thread = api.index_entitlements(async_req=True)
        >>> result = thread.get()
        ...
        return self.index_entitlements_endpoint.call_with_http_info(**kwargs)
    ...
    def validate_entitlement(
        ...
        **kwargs
        ...
        Determine whether weight estimate is below entitlement  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.validate_entitlement(move_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['move_id'] = \
            move_id
        return self.validate_entitlement_endpoint.call_with_http_info(**kwargs)
