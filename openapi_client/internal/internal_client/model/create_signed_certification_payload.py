...
class CreateSignedCertificationPayload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, date, signature, certification_text, *args, **kwargs):  # noqa: E501
        """CreateSignedCertificationPayload - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, date, signature, certification_text, *args, **kwargs):  # noqa: E501
        """CreateSignedCertificationPayload - a model defined in OpenAPI
