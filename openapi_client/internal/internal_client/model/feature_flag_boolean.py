...
class FeatureFlagBoolean(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, entity, key, match, namespace, *args, **kwargs):  # noqa: E501
        """FeatureFlagBoolean - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, entity, key, match, namespace, *args, **kwargs):  # noqa: E501
        """FeatureFlagBoolean - a model defined in OpenAPI
