...
def lazy_import():
    ...
    globals()['SignedCertificationPayload'] = SignedCertificationPayload


class SignedCertifications(ModelSimple):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'value': ([SignedCertificationPayload],),
        }
    ...
    def __init__(self, *args, **kwargs):
        """SignedCertifications - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([SignedCertificationPayload]):  # noqa: E501

        Keyword Args:
            value ([SignedCertificationPayload]):  # noqa: E501
