...
class OktaUserProfileData(ModelNormal):
    ...
    validations = {
        ('login',): {
            'regex': {
                'pattern': r'^[a-zA-Z0-9.%+-]+@[a-zA-Z0-9.-]+\.[a-zA-Z]{2,}$',  # noqa: E501
            },
        },
        ('email',): {
            'regex': {
    ...
    def openapi_types():
        ...
        return {
            ...
            'cac_edipi': (str, none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OktaUserProfileData - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            cac_edipi (str, none_type): [optional]  # noqa: E501
        """
