...
class AvailableMoveDates(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, start_date, available, *args, **kwargs):  # noqa: E501
        """AvailableMoveDates - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, start_date, available, *args, **kwargs):  # noqa: E501
        """AvailableMoveDates - a model defined in OpenAPI
