...
class MTOShipmentType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["HHG", "HHG_INTO_NTS_DOMESTIC", "HHG_OUTOF_NTS_DOMESTIC", "PPM", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["HHG", "HHG_INTO_NTS_DOMESTIC", "HHG_OUTOF_NTS_DOMESTIC", "PPM", ]  # noqa: E501
