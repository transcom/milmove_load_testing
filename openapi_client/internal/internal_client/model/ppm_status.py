...
class PPMStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["DRAFT", "SUBMITTED", "APPROVED", "COMPLETED", "CANCELED", "PAYMENT_REQUESTED", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["DRAFT", "SUBMITTED", "APPROVED", "COMPLETED", "CANCELED", "PAYMENT_REQUESTED", ]  # noqa: E501
