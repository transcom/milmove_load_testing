...
class SelectedMoveType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """SelectedMoveType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["HHG", "PPM", "UB", "POV", "HHG_INTO_NTS_DOMESTIC", "HHG_OUTOF_NTS_DOMESTIC", "HHG_PPM", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["HHG", "PPM", "UB", "POV", "HHG_INTO_NTS_DOMESTIC", "HHG_OUTOF_NTS_DOMESTIC", "HHG_PPM", ]  # noqa: E501
