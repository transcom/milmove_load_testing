...
class SignedCertificationPayload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, created_at, updated_at, date, signature, certification_text, move_id, *args, **kwargs):  # noqa: E501
        """SignedCertificationPayload - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, created_at, updated_at, date, signature, certification_text, move_id, *args, **kwargs):  # noqa: E501
        """SignedCertificationPayload - a model defined in OpenAPI
