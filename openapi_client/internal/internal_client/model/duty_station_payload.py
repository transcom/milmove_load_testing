...
class DutyStationPayload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, address_id, address, affiliation, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """DutyStationPayload - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, address_id, address, affiliation, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """DutyStationPayload - a model defined in OpenAPI
