...
class DutyLocationInternal(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, affiliation, city, state, postal_code, country, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """DutyLocationInternal - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, affiliation, city, state, postal_code, country, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """DutyLocationInternal - a model defined in OpenAPI
