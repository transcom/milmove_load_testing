...
class IndexServiceMemberBackupContactsPayload(ModelSimple):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'value': ([ServiceMemberBackupContactPayload],),
        }
    ...
    def __init__(self, *args, **kwargs):
        """IndexServiceMemberBackupContactsPayload - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([ServiceMemberBackupContactPayload]):  # noqa: E501

        Keyword Args:
            value ([ServiceMemberBackupContactPayload]):  # noqa: E501
