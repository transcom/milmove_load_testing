...
class CreateGenericMoveDocumentPayload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, upload_ids, title, move_document_type, *args, **kwargs):  # noqa: E501
        """CreateGenericMoveDocumentPayload - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, upload_ids, title, move_document_type, *args, **kwargs):  # noqa: E501
        """CreateGenericMoveDocumentPayload - a model defined in OpenAPI
