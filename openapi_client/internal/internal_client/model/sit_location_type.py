...
class SITLocationType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """SITLocationType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The list of SIT location types.., must be one of ["ORIGIN", "DESTINATION", ]  # noqa: E501

        Keyword Args:
            value (str): The list of SIT location types.., must be one of ["ORIGIN", "DESTINATION", ]  # noqa: E501
