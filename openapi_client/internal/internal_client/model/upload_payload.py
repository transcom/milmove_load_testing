...
class UploadPayload(ModelNormal):
    ...
    def _from_openapi_data(cls, id, url, filename, content_type, bytes, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """UploadPayload - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, url, filename, content_type, bytes, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """UploadPayload - a model defined in OpenAPI
