...
class DutyLocationPayload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, address_id, affiliation, created_at, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, address_id, affiliation, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """DutyLocationPayload - a model defined in OpenAPI
