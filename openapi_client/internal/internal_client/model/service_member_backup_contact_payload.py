...
class ServiceMemberBackupContactPayload(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'permission': (BackupContactPermission,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, email, permission, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """ServiceMemberBackupContactPayload - a model defined in OpenAPI

        Args:
            id (str):
            name (str, none_type):
            email (str, none_type):
            permission (BackupContactPermission):
            created_at (datetime):
            updated_at (datetime):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, email, permission, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """ServiceMemberBackupContactPayload - a model defined in OpenAPI
