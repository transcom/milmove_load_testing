...
class TransportationOffices(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TransportationOffices - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([TransportationOffice]):  # noqa: E501

        Keyword Args:
            value ([TransportationOffice]):  # noqa: E501
