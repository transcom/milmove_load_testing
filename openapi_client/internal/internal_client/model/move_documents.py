...
class MoveDocuments(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """MoveDocuments - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([MoveDocumentPayload]):  # noqa: E501

        Keyword Args:
            value ([MoveDocumentPayload]):  # noqa: E501
