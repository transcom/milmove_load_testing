...
class UpdateMovingExpense(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, moving_expense_type, description, paid_with_gtcc, amount, missing_receipt, *args, **kwargs):  # noqa: E501
        """UpdateMovingExpense - a model defined in OpenAPI
        ...
        self.paid_with_gtcc = paid_with_gtcc
        self.amount = amount
    ...
    @convert_js_args_to_python_args
    def __init__(self, moving_expense_type, description, paid_with_gtcc, amount, missing_receipt, *args, **kwargs):  # noqa: E501
        """UpdateMovingExpense - a model defined in OpenAPI
