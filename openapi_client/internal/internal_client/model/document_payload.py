...
class DocumentPayload(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'uploads': ([UploadPayload],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, service_member_id, uploads, *args, **kwargs):  # noqa: E501
        """DocumentPayload - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, service_member_id, uploads, *args, **kwargs):  # noqa: E501
        """DocumentPayload - a model defined in OpenAPI
