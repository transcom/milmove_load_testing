...
class DeptIndicator(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["NAVY_AND_MARINES", "ARMY", "AIR_FORCE", "COAST_GUARD", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["NAVY_AND_MARINES", "ARMY", "AIR_FORCE", "COAST_GUARD", ]  # noqa: E501
