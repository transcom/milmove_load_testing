...
class CancelMove(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cancel_reason, *args, **kwargs):  # noqa: E501
        """CancelMove - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, cancel_reason, *args, **kwargs):  # noqa: E501
        """CancelMove - a model defined in OpenAPI
