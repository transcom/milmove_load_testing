...
class IndexPersonallyProcuredMovePayload(ModelSimple):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'value': ([PersonallyProcuredMovePayload],),
        }
    ...
    def __init__(self, *args, **kwargs):
        """IndexPersonallyProcuredMovePayload - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([PersonallyProcuredMovePayload]):  # noqa: E501

        Keyword Args:
            value ([PersonallyProcuredMovePayload]):  # noqa: E501
