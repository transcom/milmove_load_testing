...
class FeatureFlagVariant(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, entity, key, match, variant, namespace, *args, **kwargs):  # noqa: E501
        """FeatureFlagVariant - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, entity, key, match, variant, namespace, *args, **kwargs):  # noqa: E501
        """FeatureFlagVariant - a model defined in OpenAPI
