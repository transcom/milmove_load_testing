...
[**create_moving_expense_document**](MoveDocsApi.md#create_moving_expense_document) | **POST** /moves/{moveId}/moving_expense_documents | Creates a moving expense document
...
# **create_moving_expense_document**
> MoveDocumentPayload create_moving_expense_document(move_id, create_moving_expense_document_payload)
...
with internal_client.ApiClient() as api_client:
    ...
    try:
        # Creates a moving expense document
        api_response = api_instance.create_moving_expense_document(move_id, create_moving_expense_document_payload)
        pprint(api_response)
    except internal_client.ApiException as e:
        print("Exception when calling MoveDocsApi->create_moving_expense_document: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **move_id** | **str**| UUID of the move |
 **create_moving_expense_document_payload** | [**CreateMovingExpenseDocumentPayload**](CreateMovingExpenseDocumentPayload.md)|  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | returns new moving expense document object |  -  |
**400** | invalid request |  -  |
**401** | must be authenticated to use this endpoint |  -  |
**403** | not authorized to modify this move |  -  |
**500** | server error |  -  |
