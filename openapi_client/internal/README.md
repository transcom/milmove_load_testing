...
------------ | ------------- | ------------- | -------------
*AccesscodeApi* | [**claim_access_code**](docs/AccesscodeApi.md#claim_access_code) | **PATCH** /access_codes/invalid | Updates access code as invalid by associating it with the current service member.
*AccesscodeApi* | [**fetch_access_code**](docs/AccesscodeApi.md#fetch_access_code) | **GET** /access_codes | Fetches an access code
*AccesscodeApi* | [**validate_access_code**](docs/AccesscodeApi.md#validate_access_code) | **GET** /access_codes/valid | Validate if an access code has been unused and associated with the correct move type.
...
## Documentation For Models
 ...
 - [DutyStationPayload](docs/DutyStationPayload.md)
 - [Error](docs/Error.md)
